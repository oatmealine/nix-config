# copied from https://github.com/NixOS/nixpkgs/blob/dfce2e038fa6fdbdfe2b9797b4738f6d694a8774/pkgs/by-name/ni/nih-plug/package.nix
# but with diopser and crossover since i want diopser
...
in rustPlatform.buildRustPackage rec {
  ...
  nativeBuildInputs = [
    ...
    python3
    autoPatchelfHook # not sure why this is needed.. it shouldn't be
  ];
